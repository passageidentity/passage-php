...
class ListPaginatedUsersResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ListPaginatedUsersResponse';
    ...
    */
     ...
     */
    public function getLinks(): \OpenAPI\Client\Model\PaginatedLinks
    {
     ...
     * @return $this
     */
    public function setLinks(\OpenAPI\Client\Model\PaginatedLinks $_links): static
    {
        if (is_null($_links)) {
     ...
     * @return $this
     */
    public function setCreatedBefore(int $created_before): static
    {
     ...
     * @return $this
     */
    public function setTotalUsers(int $total_users): static
    {
